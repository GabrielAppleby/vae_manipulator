...
from app.core.nvae.thirdparty import other_sync_batchnorm
from app.core.nvae.thirdparty.swish import Swish as SwishFN
from app.core.nvae.thirdparty.inplaced_sync_batchnorm import SyncBatchNormSwish

from app.core.nvae.utils import average_tensor
...
class SyncBatchNorm(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.bn = other_sync_batchnorm.SyncBatchNorm(*args, **kwargs)
...
class EncCombinerCell(nn.Module):
    def __init__(self, Cin1, Cin2, Cout, cell_type):
        ...
        # Cin = Cin1 + Cin2
        # print("                 stride: {}".format(1))
        # print("                 Primitive type: {}".format(cell_type))
        # print("                 In: {}".format(Cin2))
...
class InvertedResidual(nn.Module):
    def __init__(self, Cin, Cout, stride, ex, dil, k, g):
        ...
        # print("                 Ex: {}".format(ex))
        # print("                 hidden: {}".format(hidden_dim))
        # print("                 dil: {}".format(dil))
        # print("                 k: {}".format(k))
        # print("                 g: {}".format(g))
